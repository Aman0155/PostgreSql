...
CREATE ROLE
CREATE ROLE
Q2. grant insert on employees to Aarti , Aryansh , Aman;
GRANT

Q3. revoke update on employees from Aarti;
REVOKE
                                                            List of databases
   Name    |  Owner   | Encoding | Locale Provider |      Collate       |       Ctype        | Locale | ICU Rules |   Access privileges   
-----------+----------+----------+-----------------+--------------------+--------------------+--------+-----------+-----------------------
...
Q4. grant all privileges on products to Aryansh;
GRANT
...
Q7. revoke all privileges on departments from Aarti;
REVOKE

create schema sales;
CREATE SCHEMA

Q8. grant usage on schema sales to Aryansh;
GRANT

Q9. revoke usage on schema sales from Aryansh , Aarti , Aman;
REVOKE

Q10. grant connect on database company to Aarti;
GRANT